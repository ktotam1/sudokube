...
class OnlineSizeTestExperiment(ename2:String = "", logN: Int, minD: Int, maxD: Int, qd: Int, file_size: String)(implicit timestampedfolder:String) extends Experiment (s"ubuntuone", ename2, "ubuntuone-expts"){
    // val domain = 1562
...
object OnlineSizeTestExperiment extends ExperimentRunner {
    def qsize(cg: CubeGenerator, argument: (Int,Int,Int,Int), file_size: String, isSMS: Boolean)(implicit timestampedFolder: String, numIters: Int, be: CBackend) = {
        ...
        val expt = new OnlineSizeTestExperiment(ename, logN, minD, maxD, qd, file_size)
